...
def test_balanser():
    ...
    post_handler.add_important_post("test", PostSource("tu", "tt", "ss", url_hash="uh_important9"), "another sub", None,
                                    important=True)
    post_handler.add_important_post("test", PostSource("tu", "tt", "ss", url_hash="uh_important10"), "another sub", None,
                                    important=True)
    post_handler.add_important_post("test", PostSource("tu", "tt", "ss", url_hash="uh_important11"), "another sub", None,
                                    important=True)
    for i in range(120):
